...
```bash
git remote add encore encore://warehouse-management-system-oigi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/warehouse-management-system-oigi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/warehouse-management-system-oigi/settings/integrations/github)
